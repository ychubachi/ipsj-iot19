...
In principle, only works cited in the text are included in the list of
references.  References may be listed in the order of citation or
alphabetized in the order of the authors' initials.
...
\begin{acknowledgment}
This manuscript is based on the previous style file for A4 landscape
papers.  The Editorial Board of the JIP sincerely thanks its members for
their effort in preparing the previous version.
\end{acknowledgment}
